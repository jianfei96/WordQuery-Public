...
from aqt.utils import shortcut, showInfo, HelpPage
...
class ParasDialog(QDialog):
    ...
    def build(self):
        ...
        self.ffmpeg_edit = QLineEdit(config.ffmpeg_path)
        self.ffmpeg_edit.setPlaceholderText("Auto-detect if empty")
        ...
        ffmpeg_save_btn = QPushButton("Save ffmpeg path")
...
class FoldersManageDialog(QDialog):
    ...
    def add_folder(self):
        dir_ = QFileDialog.getExistingDirectory(self,
                                                caption=u"Select Folder", directory="", options=QFileDialog.Option.ShowDirsOnly | QFileDialog.Option.DontResolveSymlinks)
        if dir_:
...
class OptionsDialog(QDialog):
    ...
    def __init__(self, parent=0):
        ...
        self.setWindowFlags(Qt.WindowType.CustomizeWindowHint |
                            Qt.WindowType.WindowTitleHint | Qt.WindowType.WindowCloseButtonHint | Qt.WindowType.WindowMinMaxButtonsHint)
        self.parent = parent
    ...
    def build(self):
        ...
        self.dicts_layout.setSizeConstraint(QLayout.SizeConstraint.SetMinAndMaxSize)
    ...
    def build_mappings_layout(self, model):
        ...
        label3.setSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
    ...
    def show_models(self):
        ...
        ret = StudyDeck(mw, names=lambda: sorted(mw.col.models.all_names()),
                        accept=_("CHOOSE"), title=_("CHOOSE_NOTE_TYPE"),
                        parent=self, buttons=[edit],
    ...
    def add_dict_layout(self, i, **kwargs):
        ...
        dict_combo.setFocusPolicy(
            Qt.FocusPolicy.TabFocus | Qt.FocusPolicy.ClickFocus | Qt.FocusPolicy.StrongFocus | Qt.FocusPolicy.WheelFocus)
...
class Updater(QThread):
    ...
    def run(self):
        try:
            req = urllib.request.Request(Endpoint.check_version)
