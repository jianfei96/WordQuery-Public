...
trans = {
    ...
    'QUERY': {'zh_CN': u'查询', 'en': u'Query', 'fr': u'Rechercher'},
    'MANAGE': {'zh_CN': u'管理', 'en': u'Manage', 'fr': u'Gérer'},
    'CHOOSE': {'zh_CN': u'选择', 'en': u'Choose', 'fr': u'Choisir'},
    'CHOOSE_NOTE_TYPE': {'zh_CN': u'选择笔记类型', 'en': u'Choose note type', 'fr': u'Choisir le type de note'},
    'OPTIONS': {'zh_CN': u'选项', 'en': u'Options', 'fr': u'Options'},
    'QUERY_SELECTED': {'zh_CN': u'查询选中', 'en': u'Query Selected', 'fr': u'Rechercher sélectionné'},
    'WORD_QUERY': {'zh_CN': u'单词查询', 'en': u'Word Query', 'fr': u'Recherche de mots'},
    'QUERY_ALL_FIELDS': {'zh_CN': u'查询所有字段', 'en': u'Query All Fields', 'fr': u'Rechercher tous les champs'},
    'QUERY_CURRENT_FIELD': {'zh_CN': u'查询当前字段', 'en': u'Query Current Field', 'fr': u'Rechercher le champ actuel'},
}
